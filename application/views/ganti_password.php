                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('auth/ganti_password_aksi') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?= form_error('pass_baru', '<span class="text-danger text-small">', '</span>') ?>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="ulang_pass" type="ulang_pass" class="form-control" name="ulang_pass" tabindex="2">
                                        <?= form_error('ulang_pass', '<span class="text-danger text-small">', '</span>') ?>
                                    </div>
