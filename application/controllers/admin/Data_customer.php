...
class Data_customer extends CI_Controller
{
    ...
    {
        $data['customer'] =  $this->rental_model->get_data('customer')->result_array();
    ...
    public function tambah_customer_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            <strong>Data Customer Berhasil Ditambahkan!
    ...
    {
        $data['customer'] = $this->db->get_where('customer', ['id_customer' => $id])->row_array();
    ...
    public function update_customer_aksi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Data Customer Berhasil Diupdate!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>');
    ...
    public function delete_customer($id)
    {
        ...
        <strong>Data Customer Berhasil Dihapus!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>');
