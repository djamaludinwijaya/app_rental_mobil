...
class Data_mobil extends CI_Controller
{
    ...
    {
        $data['mobil'] = $this->rental_model->get_data('mobil')->result_array();
    ...
    {
        // $data['mobil'] =  $this->db->query("SELECT * FROM mobil mb, type tp WHERE mb.kode_type= tp.kode_type AND mb.id_mobil = '$id'")->row_array();

        $data['mobil'] = $this->db->query("SELECT * FROM mobil WHERE id_mobil = $id")->row_array();
        $data['type']  = $this->rental_model->get_data('type')->result_array();
