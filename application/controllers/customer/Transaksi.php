...
class Transaksi extends CI_Controller
{
    public function index()
    {
        ...
        AND tr.id_customer = cs.id_customer AND cs.id_customer= $customer ORDER BY id_rental DESC")->result_array();
    ...
    public function pembayaran($id)
    {
        $data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, mobil mb, customer cs
        WHERE tr.id_mobil = mb.id_mobil 
        AND tr.id_customer = cs.id_customer AND tr.id_rental= $id ORDER BY id_rental DESC")->result_array();
    ...
    public function pembayaran_aksi()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Bukti Pembayaran Anda Berhasil Diupload!
    ...
    public function cetak_invoice($id)
    {
        $data['transaksi'] = $this->db->query("SELECT * FROM transaksi tr, mobil mb, customer cs
        WHERE tr.id_mobil = mb.id_mobil 
        AND tr.id_customer = cs.id_customer AND tr.id_rental= $id")->result_array();
